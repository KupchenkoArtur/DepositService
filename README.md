...
```
cd existing_repo
git remote add origin https://git.astondevs.ru/laboratory/a-geld/java-dev/deposit-service.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.astondevs.ru/laboratory/a-geld/java-dev/deposit-service/-/settings/integrations)
